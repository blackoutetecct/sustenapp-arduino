...
const int HIDIRCO_TX = 0,HIDIRCO_RX = 0,ELETRICO_TX = 0,ELETRICO_RX = 0;
...
void setup() {
    ...
    /* SERIAL */
    Serial.begin(115200);
    Serial2.begin(9600, SERIAL_8N1, HIDIRCO_RX, HIDIRCO_TX);
    Serial3.begin(4800, SERIAL_8N1, ELETRICO_RX, ELETRICO_TX);

    /* LED ACIONAMENTO */
    pinMode(LED_ACIONEMENTO, OUTPUT);
...
String recebeInformacaoHidrico() {
    Serial2.println("relatorio_hidrico");
...
String recebeInformacaoEletrico() {
    Serial3.println("relatorio_eletrico");
